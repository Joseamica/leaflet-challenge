...
d3.json(APILink, function (data) {
  ...
  for (var i = 0; i < data.features.length; i++) {
    ...
    if (location.properties.mag) {
      heat.push([location.geometry.coordinates[1], location.geometry.coordinates[0], location.properties.mag * 1500]);
    }
  }
  console.log(heat);

  var infolegend = "<h1>Earthquake Magnitudes</h1>" +
    "<div class=\"labels\">" +
